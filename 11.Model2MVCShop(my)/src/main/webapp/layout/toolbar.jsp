...
<div class="navbar  navbar-inverse navbar-fixed-top">
	...
	<div class="container">
	               ...
	               <c:if test="${sessionScope.user.role == 'admin'}">
		              <li class="dropdown">
		                     ...
		                     <ul class="dropdown-menu">
		                         ...
		                         <li><a href="#" class="product">판매상품관리</a></li>
   	...
   	<script type="text/javascript">
		...
		$(function() {
			$("a[href='#' ].product:contains('판매상품관리')").on("click", function() {
				self.location = "/product/listProduct/manage";
			});
		});

		$(function() {
			$("a[href='#' ]:contains('배송 관리')").on("click", function() {
				self.location = "/purchase/listDelivery";
			});
		});

		$(function() {
			$("a[href='#' ]:contains('상 품 검 색'), a[href='#' ]:contains('상품검색')").on("click", function() {
